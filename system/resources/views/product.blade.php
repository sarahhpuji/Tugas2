...
<head>
	<title>Product | RAF Shop eCommerce - Free Bootstrap Dashboard Template</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{ url('product') }}"product.html class="active"><i class="lnr lnr-code"></i> <span>Product</span></a></li>
						<li><a href="{{ url('category') }}"category.html class=""><i class="lnr lnr-chart-bars"></i> <span>Category</span></a></li>
